...
const bg:Record<string,string>={
  ...
  "Contacts shown only to residents of the selected building.":"Контактите се показват само на живущите в избраната сграда.",
  "For immediate danger to life or property, call 112.":"При непосредствена опасност за живота или имуществото се обадете на 112.",
  "Add Emergency Contact":"Добави спешен контакт",
  "Edit Emergency Contact":"Редактирай спешен контакт",
  "Contact type":"Тип контакт",
  "Elevator emergency":"Авария с асансьор",
  "Emergency building manager":"Спешен контакт с домоуправител",
  "Plumber":"Водопроводчик",
  "Electrician":"Електротехник",
  "Security":"Охрана",
  "Other":"Друго",
  "Name / Company":"Име / Компания",
  "Example: Lift Service Ltd.":"Пример: Асансьор Сервиз ООД",
  "Phone number":"Телефонен номер",
  "Note (optional)":"Бележка (по избор)",
  "Example: 24/7 emergency service":"Пример: 24/7 аварийно обслужване",
  "Save Contact":"Запази контакт",
  "No emergency contacts added yet.":"Все още няма добавени спешни контакти.",
  "Emergency contact saved.":"Спешният контакт е запазен.",
  "Emergency contact removed.":"Спешният контакт е премахнат.",
  "Remove this emergency contact?":"Да се премахне ли този спешен контакт?",
  "Contact name and phone number are required.":"Името и телефонният номер са задължителни.",
  "Elevator, building manager and other urgent building contacts":"Асансьор, домоуправител и други спешни контакти за сградата",
